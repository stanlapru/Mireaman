...
class Game(object):
    def __init__(self):
        ...
        self.levels = []
        self.levels.append(Level(fileName = "./resources/platformer-temp/level1.tmx"))
        ...
        self.overlay = pygame.image.load("./resources/platformer-temp/overlay.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.sprites = SpriteSheet("./resources/platformer-temp/player.png")
